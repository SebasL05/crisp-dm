...
\begin{itemize}
    ...
    \item \textbf{Enlace de la aplicación (Streamlit):} \url{https://sebasl05-crisp-dm-app-qa9jgp.streamlit.app/}
    \item \textbf{Repositorio de GitHub:} \url{https://github.com/SebasL05/crisp-dm.git}
\end{itemize}
